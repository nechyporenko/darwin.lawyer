 ...
 * 
 */
class CDVZ_video_popup extends Codevz_Plus {
	...
	public function in() {
		...
		Codevz_Plus::vc_map( array(
			...
			'params'		=> array(
				...
				array(
					"type"        	=> "dropdown",
					"heading"     	=> esc_html__("Icon size", 'codevz'),
					"param_name"  	=> "size",
					'value'			=> array(
						'Size 1' 		=> 'cz_video_popup_size_1',
						'Size 2' 		=> 'cz_video_popup_size_2',
						'Size 3' 		=> 'cz_video_popup_size_3',
						'Size 4' 		=> 'cz_video_popup_size_4',
						'Size 5' 		=> 'cz_video_popup_size_5',
						'Size 6' 		=> 'cz_video_popup_size_6',
					),
					'std' 			=> 'cz_video_popup_size_2',
					'edit_field_class' => 'vc_col-xs-99',
					'dependency'	=> array(
						'element'		=> 'icon',
						'not_empty'	 	=> true
	...
	public function out( $atts, $content = '' ) {
		...
		$lightbox = $atts['inline'] ? 'cz_no_lightbox' : 'lightbox';
		...
		// Out
		$out = '<div id="' . $atts['id'] . '"' . Codevz_Plus::classes( $atts, $classes ) . Codevz_Plus::data_stlye( $css, $css_t, $css_m ) . '><div' . Codevz_Plus::tilt( $atts ) . '><div class="cz_vp_c"><a href="' . $atts['video'] . '" class="' . $lightbox . '">' . $image . '<div class="cz_vp_inner"><span><i class="' . $atts['icon'] . '"></i></span>' . $atts['title'] . '</div></a></div></div></div>';
