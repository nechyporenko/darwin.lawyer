 ...
 * 
 */
class CDVZ_contact_form_7 extends Codevz_Plus {
	...
	public function in() {
		...
		Codevz_Plus::vc_map( array(
			...
			'params'		=> array(
				...
				array( 'type' => 'cz_hidden','param_name' => 'sk_label_tablet' ),
				...
				array(
					'type' 			=> 'cz_sk',
					'param_name' 	=> 'sk_select',
					"heading"     	=> esc_html__( "Select option", 'codevz'),
					'button' 		=> esc_html__( "Select", 'codevz'),
					'edit_field_class' => 'vc_col-xs-99',
					'settings' 		=> array( 'color', 'text-align', 'font-size', 'background', 'border' )
				),
				array( 'type' => 'cz_hidden','param_name' => 'sk_select_tablet' ),
				array( 'type' => 'cz_hidden','param_name' => 'sk_select_mobile' ),

				array(
					'type' 			=> 'cz_sk',
					'param_name' 	=> 'sk_dropdown',
					"heading"     	=> esc_html__( "Select dropdown", 'codevz'),
					'button' 		=> esc_html__( "Select dropdown", 'codevz'),
					'edit_field_class' => 'vc_col-xs-99',
					'settings' 		=> array( 'color', 'text-align', 'font-size', 'background', 'border' )
				),
				array( 'type' => 'cz_hidden','param_name' => 'sk_dropdown_tablet' ),
				array( 'type' => 'cz_hidden','param_name' => 'sk_dropdown_mobile' ),
				...
				array( 'type' => 'cz_hidden','param_name' => 'sk_p_tablet' ),
				...
				array( 'type' => 'cz_hidden','param_name' => 'sk_p_1_tablet' ),
				...
				array( 'type' => 'cz_hidden','param_name' => 'sk_p_2_tablet' ),
				...
				array( 'type' => 'cz_hidden','param_name' => 'sk_p_3_tablet' ),
				...
				array( 'type' => 'cz_hidden','param_name' => 'sk_p_4_tablet' ),
				...
				array( 'type' => 'cz_hidden','param_name' => 'sk_p_5_tablet' ),
				...
				array( 'type' => 'cz_hidden','param_name' => 'sk_p_6_tablet' ),
				...
				array( 'type' => 'cz_hidden','param_name' => 'sk_p_7_tablet' ),
				...
				array( 'type' => 'cz_hidden','param_name' => 'sk_p_8_tablet' ),
				...
				array( 'type' => 'cz_hidden','param_name' => 'sk_p_9_tablet' ),
				...
				array( 'type' => 'cz_hidden','param_name' => 'sk_p_10_tablet' ),
				...
				array( 'type' => 'cz_hidden','param_name' => 'sk_p_11_tablet' ),
				...
				array( 'type' => 'cz_hidden','param_name' => 'sk_p_12_tablet' ),
				...
				array( 'type' => 'cz_hidden','param_name' => 'sk_p_13_tablet' ),
				...
				array( 'type' => 'cz_hidden','param_name' => 'sk_p_14_tablet' ),
				...
				array( 'type' => 'cz_hidden','param_name' => 'sk_p_15_tablet' ),
	...
	public function out( $atts, $content = '' ) {
		...
		if ( isset( $public ) || Codevz_Plus::$vc_editable || Codevz_Plus::$is_admin ) {
			...
			$css_array = array(
				...
				'sk_input' 	=> $css_id . ' input:not([type="submit"]), ' . $css_id . ' input[type="date"], ' . $css_id . ' textarea',
				'sk_button' => $css_id . ' input[type="submit"], ' . $css_id . ' button',
				'sk_button_hover' => $css_id . ' input[type="submit"]:hover, ' . $css_id . ' button:hover',
				'sk_select' => $css_id . ' .nice-select',
				'sk_dropdown' => $css_id . ' .nice-select .list',
				'sk_p' 		=> $css_id . ' p',
		...
		return Codevz_Plus::_out( $atts, $out, 'select' );
	}
