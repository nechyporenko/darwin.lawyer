 ...
 * 
 */
class CDVZ_animated_text extends Codevz_Plus {
	...
	public function out( $atts, $content = '' ) {
		...
		wp_enqueue_script( 'codevz-animated-text' );
		return Codevz_Plus::_out( $atts, $out, 'animated_text' );
	}
}