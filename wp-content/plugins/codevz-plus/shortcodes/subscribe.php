 ...
 * 
 */
class CDVZ_subscribe extends Codevz_Plus {
		...
		Codevz_Plus::vc_map( array(
			...
			'params'		=> array(
				...
				array(
					...
					'description'	=> esc_html__('Mailchip url or Google feedburner url', 'codevz'),
					'edit_field_class' => 'vc_col-xs-99',
					'value' 		=> 'http://feedburner.google.com/codevz',
					"param_name"  	=> "action"
				),
				array(
					"type"        	=> "textfield",
	...
	public function out( $atts, $content = '' ) {
		...
		if ( isset( $public ) || Codevz_Plus::$vc_editable || Codevz_Plus::$is_admin ) {
			...
			$custom = ( $atts['position'] === 'center' ) ? 'margin: 0 auto;float:none;display:table' : ( ( $atts['position'] === 'right' ) ? 'float: right;' : '' );
