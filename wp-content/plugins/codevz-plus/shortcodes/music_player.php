 ...
 * 
 */
class CDVZ_music_player extends Codevz_Plus {
	...
	public function out( $atts, $content = '' ) {
		...
		foreach ( $tracks as $track ) {
			...
			$tracks_out .= $icon ? '<div class="sm2-col"><a href="' . $icon_link . '" target="_blank" title="' . $icon_title . '" class="sm2-icon"><i class="' . $icon . '"></i></a></div>' : '';
			$tracks_out .= '</div></li>';
		}
