 ...
 * 
 */
class CDVZ_free_line extends Codevz_Plus {
	...
	public function in() {
		...
		Codevz_Plus::vc_map( array(
			...
			'params'		=> array(
				...
				array( 'type' => 'cz_hidden','param_name' => 'sk_circles_tablet' ),
				array( 'type' => 'cz_hidden','param_name' => 'sk_circles_mobile' ),
	...
	public function out( $atts, $content = '' ) {
		...
		if ( $atts['css_animation'] && $atts['css_animation'] !== 'none' ) {
			...
			$animation = ' class="wpb_animate_when_almost_visible wpb_' . $atts['css_animation'] . ' ' . $atts['css_animation'] . '"' . $delay;
