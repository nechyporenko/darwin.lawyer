 ...
 * 
 */
class CDVZ_show_more_less extends Codevz_Plus {
	...
	public function out( $atts, $content = '' ) {
		...
		if ( isset( $public ) || Codevz_Plus::$vc_editable || Codevz_Plus::$is_admin ) {
			...
			$css .= $atts['gradient'] ? $css_id . ' .cz_sml_overlay{background:linear-gradient(transparent 50%, ' . $atts['gradient'] . ' 100%)}' : '';
		...
		// Out
		$out = '<div id="' . $atts['id'] . '"' . Codevz_Plus::classes( $atts, array( $atts['id'], 'cz_sml' ) ) . Codevz_Plus::data_stlye( $css, $css_t, $css_m ) . '><div class="cz_sml_inner"><div class="cz_wpe_content">' . do_shortcode( $content ) . '</div><div class="cz_sml_overlay"></div></div><a href="#"><span>' . $atts['more'] . $more_icon . '</span><span>' . $atts['less'] . $less_icon . '</span></a></div>';
