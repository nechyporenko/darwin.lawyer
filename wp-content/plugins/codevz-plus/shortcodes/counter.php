 ...
 * 
 */
class CDVZ_counter extends Codevz_Plus {
	...
	public function out( $atts, $content = '' ) {
		...
		$number = $atts['number'] ? '<span class="cz_counter_num_wrap"><span class="cz_counter_num" >' . $atts['number'] . '</span>' . $symbol . '</span>' : '';

		$out = '<div id="' . $atts['id'] . '" data-duration="' . $atts['duration'] . '000" data-delay="' . $atts['delay'] . '000"' . Codevz_Plus::classes( $atts, $classes ) . Codevz_Plus::data_stlye( $css, $css_t, $css_m ) . '>' . $before . $number . $after . '</div>';
