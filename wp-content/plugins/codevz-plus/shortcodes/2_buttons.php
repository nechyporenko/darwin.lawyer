 ...
 * 
 */
class CDVZ_2_buttons extends Codevz_Plus {
		...
		Codevz_Plus::vc_map( array(
			...
			'params'		=> array(
				...
				array(
					...
					'value'			=> array(
						esc_html__( "Left", 'codevz' ) 			=> 'relative;float:left',
						esc_html__( "Center", 'codevz' ) 		=> 'relative;display: table;margin:0 auto',
						esc_html__( "Right", 'codevz' ) 		=> 'relative;float:right',
					),
					'std'			=> 'relative;display: table;margin:0 auto'
				),
				...
				array(
					'type' 			=> 'cz_sk',
					'param_name' 	=> 'sk_icon',
					"heading"     	=> esc_html__( "Separator styling", 'codevz'),
