 ...
 * 
 */
class CDVZ_hotspot extends Codevz_Plus {
		...
		Codevz_Plus::vc_map( array(
			...
			'params'		=> array(
				...
				array(
					...
					'value'		=> array(
						'Default'	=> '',
						'Pulse'		=> 'cz_hotspot_pulse',
						'Waves'		=> 'cz_hotspot_waves',
						'Ripple'	=> 'cz_hotspot_ripple',
					),
				),
				array(
					'type'			=> 'dropdown',
	...
	public function out( $atts, $content = '' ) {
		...
		// Icon
		$icon = $atts['icon'] ? '<i class="' . $atts['icon'] . '"></i>' : '';
		...
		return Codevz_Plus::_out( $atts, $out, 'front_end_draggable( ".vc_cz_hotspot" )' );
	}
