    ...
    public function add_options_html() {
      ...
      echo '<div class="csf csf-options">';
        ...
        echo '<div class="csf-header-inner">';
          ...
          echo ( $this->settings['show_search'] ) ? '<div class="csf-search"><input type="text" placeholder="'. esc_html__( 'Search option(s)', 'codevz' ) .'" /></div>' : '';
          echo '</div>';

          echo '<div class="csf-header-right">';

            echo '<div class="csf-buttons">';
            submit_button( esc_html__( 'Save', 'codevz' ), 'primary csf-save'. $ajax_class, 'save', false, array( 'data-save' => esc_html__( 'Saving...', 'codevz' ) ) );
