  ...
  class CSF_Field_group extends CSF_Fields {
    ...
    public function output() {
      ...
      echo '</div>';
        ...
        //Codevz
        //echo '<div class="csf-field csf-text-right"><a href="#" class="button csf-warning-primary csf-cloneable-remove"><i class="csf-cloneable-remove fa fa-times" title="Remove"></i></a></div>';
      ...
      echo '<div class="csf-cloneable-wrapper">';
        ...
        if( ! empty( $this->value ) ) {
          ...
          foreach ( $this->value as $key => $value ) {
            ...
            $title = ( $title === 'icon' ) ? esc_html__( 'Icon & Text', 'codevz' ) : $title; // CODEVZ
      ...
      //Codevz
      echo '<a href="#" class="button button-primary csf-cloneable-add"><i class="fa fa-plus" />'. $this->field['button_title'] .'</a>';
