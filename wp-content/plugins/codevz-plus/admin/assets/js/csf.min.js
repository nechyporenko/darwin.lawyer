        ...
        if( !CSF.vars.importer_modal_loaded ) {
          ...
          $.ajax({
            ...
            success: function( content ) {
              ...
              $load.on('click', '.cz_demo', function ( e ) {

                e.preventDefault();

                if ( $( this ).hasClass('demo_active') ) {
                  $( '.cz_demo' ).removeClass('demo_active demo_deactive');
                } else {
                  $( this ).removeClass('demo_deactive').addClass('demo_active').siblings().removeClass('demo_active').addClass('demo_deactive');
                }
